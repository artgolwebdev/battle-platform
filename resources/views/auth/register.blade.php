            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_company" id="is_company" value="1" {{ old('is_company') ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3" id="company_name_wrapper" style="display: {{ old('is_company') ? 'flex' : 'none' }};">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                const wrapper = document.getElementById('company_name_wrapper');
